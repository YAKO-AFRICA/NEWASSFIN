                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" class="form-control" id="primepricipale" name="primepricipale" 
                                    min="1000" value="{{ $contrat->primepricipale ?? '' }}" readonly>
                            </div>
                            <div class="col-12 mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Activer la section correspondante au chargement de la page
    ...
    //             input.required = true;
    //         });
    //     } else if (selectedMode.value === 'Mobile_money' || selectedMode.value === 'EBANK') {
    //         if (modeMobile) modeMobile.style.display = 'block';
    //         inputsMobile.forEach(input => {
    //             input.required = true;
    //         });
