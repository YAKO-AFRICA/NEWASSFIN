                        ...
                        <div class="col-md-4">
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="card-title fw-bold">Bulletin Soutra et CGU</h5>
                                    <p class="card-text text-muted">
                                        Telechargez un bulletin vierge au format PDF pour impression. 
                                        Formulaire standard pr�t � �tre rempli manuellement.
                                    </p>

                                    <a href="{{ route('prod.dowloadYkeBulletinEtCGU', 'LPREVO') }}" target="_blank" class="btn-prime btn-prime-two d-block">
                                        <button type="button" class="btn btn-outline-primary mt-2">
                                            <i class="bi bi-file-pdf me-1"></i>
                                            Telecharger ici
                                        </button>
