...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function calculerSimulation() {
            ...
            const primeTotale = prime + fraie_adhesion;
            ...
            afficherResultat(prime, capital, primeTotale);
        ...
        function afficherResultat(prime, capital, primeTotale){

            document.getElementById('result').innerHTML = `
                <tr>
                    <td>${garantieObli[0].libelle}</td>
                    <td>${prime.toLocaleString()}</td>
                    <td>${Number(capital).toLocaleString()}</td>
                </tr>
            `;

            document.getElementById('primeTotal').innerHTML =
                primeTotale.toLocaleString();
