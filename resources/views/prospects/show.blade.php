...
<div class="page-content">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><strong>Ville:</strong> {{ $prospect->ville->MonLibelle ?? 'Non renseigné' }}</p>
                    ...
                    <div class="card-body">
                        <form action="{{ route('prospect.followup.store', $prospect->uuid) }}" method="POST">
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" id="submitBtnProspe" class="btn btn-primary">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            radios.forEach(radio => {
                ...
                radio.addEventListener("change", function () {
                    ...
                    // ajouter la classe au label sélectionné
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('submitBtnProspe').addEventListener('click', function(e) {
                this.disabled = true;
                this.innerHTML = '<i class="bx bx-loader-alt bx-spin fs-6"></i> Enregistrement...';
                e.preventDefault();
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            radiostype.forEach(function(radio){

                radio.addEventListener("change", function () {

                    // retirer la classe active sur tous les labels
                    document.querySelectorAll('label[for^="type_"]').forEach(function(label){
                        label.classList.remove("natureActif");
                    });
